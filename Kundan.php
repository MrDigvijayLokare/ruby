            ...
            <div class="col-12 text-center">
                <div class="page-title-content">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="index.php" class="active">Kundan jewellery </a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_1.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">kundan Necklace with pearls</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_2.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">kundan Necklace with diamond stone</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_3.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">kundan wedding kit</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_4.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">green pearls Necklace</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_5.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">diamond stone Necklace</a></h2>
                                          
                                            <span class="price">&#x20B9;700000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band seal
                                                in body heat.</p>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_6.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">fancy wedding kit</a></h2>
                                          
                                            <span class="price">&#x20B9;799999.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band seal
                                                in body heat.</p>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_7.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php"></a>green and gold combination</h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_8.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">pearls and diamond Necklace</a></h2>
                                          
                                            <span class="price">&#x20B9;999999.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band seal
                                                in body heat.</p>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_9.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">star design Necklace</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_10.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">diamond stones design</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_11.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">flower design kundan Necklace</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Kundan jewellery/Kundan_jewellery_12.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden kundan Necklace</a></h2>
                                          
                                            <span class="price">&#x20B9;121000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band seal
                                                in body heat.</p>
