                    ...
                    <div class="tab-content" id="login-reg-tabcontent">
                        <div class="tab-pane fade show active" id="login" role="tabpanel">
                            ...
                            <form action="" method="post" autocomplete="off" >
                                    ...
                                    <input type="text" name="usernameemail" id="usernameemial" placeholder="Enter UserName or Email" required  value="" > 
                                    ...
                                    <div class="single-input-item">
                                        <div class="login-reg-form-meta d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#register" class="forget-pwd">Forget Password?</a>
                                        </div>
                                    </div>
                            ...
                            <div class="login-reg-form-wrap">
                                <form action="" class="" method="post" autocomplete="off" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="single-input-item">
                                            <input type="text"  name="confirmpassword" id="confirmpassword" value="" placeholder="Confirm Password" required> 
