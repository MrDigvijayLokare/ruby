                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_1.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">pure diamond Necklace</a></h2>
                                           
                                            <span class="price">&#x20B9;250000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                ...
                                                seal
                                                in body heat.</p>
                                            <a href="single-product.php" class="btn btn-add-to-cart">+ Add to
                                                Cart</a>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_2.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">diamond Necklace</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_3.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">Necklace with pearls</a></h2>
                                           
                                            <span class="price">&#x20B9;175000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_4.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">beautyfull Necklace with green pearls</a></h2>
                                           
                                            <span class="price">&#x20B9;350000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_5.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">with golden round shape</a></h2>
                                           
                                            <span class="price">&#x20B9;155000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_6.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">wing shape Necklace</a></h2>
                                           
                                            <span class="price">&#x20B9;375000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_7.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">Necklace with small diamonds</a></h2>
                                           
                                            <span class="price">&#x20B9;160000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_8.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">small niddles</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_9.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">eagle wing shape with pearls</a></h2>
                                           
                                            <span class="price">&#x20B9;275000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_10.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">with golden color</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_11.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">beautyfull niddles</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_12.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">beautyfull pearls</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_13.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden and silver combination</a></h2>
                                           
                                            <span class="price">&#x20B9;135000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_14.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden and red combination</a></h2>
                                           
                                            <span class="price">&#x20B9;145000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/dimond/Necklaces/dimond_Necklaces_15.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">diamond Necklace with black pearl</a></h2>
                                           
                                            <span class="price">&#x20B9;165000.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><img src="assets/img/cancel.png" alt="Close"
                                        ...
                                        <div class="product-thumb-carousel owl-carousel">
                                            <div class="single-thumb-item">
                                                <a href="single-product.php"><img class="img-fluid"
                                                        src="assets/img/single-pro-thumb.jpg" alt="Product" /></a>
                                            </div>

                                            <div class="single-thumb-item">
                                                <a href="single-product.php"><img class="img-fluid"
                                                        src="assets/img/single-pro-thumb-2.jpg" alt="Product" /></a>
                                            </div>

                                            <div class="single-thumb-item">
                                                <a href="single-product.php"><img class="img-fluid"
                                                        src="assets/img/single-pro-thumb-3.jpg" alt="Product" /></a>
                                            </div>

                                            <div class="single-thumb-item">
                                                <a href="single-product.php"><img class="img-fluid"
                                                        src="assets/img/single-pro-thumb-4.jpg" alt="Product" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
