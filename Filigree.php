            ...
            <div class="col-12 text-center">
                <div class="page-title-content">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="index.php" class="active">Filigree jewellery</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_1.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">Filigree Necklace</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_2.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">Filigree Necklace with flower design</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_3.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden Filigree Necklace and Earrings</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_4.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">silver Filigree Earrings</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_5.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">silver and golden round shape design</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_6.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden Necklace and pearls</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_7.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden Filigree Necklace and Earring</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_8.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">silver pearls</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_9.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden Filigree Necklace</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_10.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">silver and golden pearls Filigree</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_11.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Filigree jewellery/Filigree_jewellery_12.JPG"
                                                                               alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">gold Filigree Bangles</a></h2>
                            ...
                            <div class="shopping-option">
                                ...
                                <div class="shopping-option-item">
                                    ...
                                    <ul class="sidebar-list">
                                        <li><a href="/.php.php">.php jewellery</a></li>
                                        <li><a href="/gemstone.php">gemstone jewellery</a></li>
                                        <li><a href="/Kundan.php">Kundan jewellery</a></li>
                                        <li><a href="/Filigree.php">Filigree jewellery</a></li>
                                        <li><a href="/Temple.php">Temple jewellery</a></li>
