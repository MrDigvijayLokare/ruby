                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_1.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">star Nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_2.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">perls design</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_3.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_4.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">gold outlet </a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_5.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">single layer</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_6.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">traditional Nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_7.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">small size nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_8.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_9.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">single nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_10.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">golden nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_11.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">silver and gold nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_12.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_13.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">diamond and gold nosepin</a></h2>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_14.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>
                                        ...
                                        <div class="product-details">
                                            ...
                                            <span class="price">&#x20B9;14999.00</span>
                                            <p class="products-desc">Ideal for cold-weathered training worked lorem
                                                outdoors, the Chaz Hoodie promises superior warmth with every wear.
                                                Thick material blocks out the wind as ribbed cuffs and bottom band
                                                seal
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <figure class="product-thumb">
                                            <a href="single-product.php"><img src="assets1/Gold/Nosepin/Gold_Nosepin_15.JPG"
                                                    alt="Products" class="img-fluid"></a>
                                        </figure>

                                        <div class="product-details">
                                            <h2><a href="single-product.php">small gold nosepin</a></h2>
